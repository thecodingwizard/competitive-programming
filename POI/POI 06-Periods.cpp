 ...
 * - Therefore, we just need a way to find, for every prefix of the given string, the minimum length of a prefix-suffix.
 ...
 * - The prefix function pi[i] = longest prefix of the substring s[0...i] which is also a suffix of this substring.
 *   - We can compute this in O(n) time; see the cp-algorithms link.
