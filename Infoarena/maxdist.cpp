...
int main() {
    ...
    F0R(i, q) {
        ...
        if (a == -1) a = x;
            ...
            if (getDist(x, b) > getDist(a, b) && getDist(x, b) > getDist(a, x)) a = x;
            else if (getDist(a, x) > getDist(a, b) && getDist(a, x) > getDist(x, b)) b = x;
        }
        ans2.pb(getDist(a, b));
    }
    ...
    F0R(i, n) {
        ...
        if (a == -1) a = i;
            ...
            if (getDist(i, b) > getDist(a, b) && getDist(i, b) > getDist(a, i)) a = i;
            else if (getDist(a, i) > getDist(a, b) && getDist(a, i) > getDist(i, b)) b = i;
        }
    }
    vi ans; ans.pb(getDist(a, b));
    reverse(all(queries));
    trav(x, queries) {
        if (a == -1) a = x;
        else if (b == -1) b = x;
