...
int main() {
    ...
    F0R1(caseNum, t) {
        ...
        F0R(i, n) {
            ...
            ll goodEnoughMin = i - ans;
            ll goodEnoughCt = goodEnoughMax * goodEnoughMin + goodEnoughMax + goodEnoughMin;
            ...
            ll tooGoodMin = i - ans;
            ll tooGoodCt = tooGoodMax * tooGoodMin + tooGoodMax + tooGoodMin;

            finalAns += goodEnoughCt - tooGoodCt;
            if (abs(A[i] - B[i]) <= k) finalAns++;
        }
